...
const HOOK_FONT_GROUPS: { label: string; fonts: string[] }[] = [
  {
    ...
    fonts: [
      ...
      "Antonio", "Six Caps", "League Spartan", "Bungee", "Druk-style Khand",
  ...
  },
  {
    ...
    fonts: [
      ...
      "Lustria", "Old Standard TT", "Volkhov", "Trajan Pro substitute",
  ...
  },
  {
    ...
    fonts: [
      ...
      "Nova Square", "Old London", "Pirata One", "Fascinate", "Fascinate Inline",
  ...
  },
  {
    ...
    fonts: [
      ...
      "Iceberg", "Audiowide", "Goldman", "Rubik Mono One", "Syne", "Syne Mono",
      "Syncopate", "Major Mono Display", "Familjen Grotesk", "Sofia Sans",
      "Sofia Sans Extra Condensed", "Truculenta", "Recursive", "Mona Sans",
      "Inter Variable", "Bricolage Grotesque", "Wix Madefor Display",
      "Wix Madefor Text",
    ],
  },
  {
    ...
    fonts: [
      ...
      "Concert One", "Engagement", "Foldit", "Fontdiner Swanky", "Gluten",
      "Gochi Hand", "Graduate", "Kavivanar", "Lakki Reddy", "Leckerli One",
      "Lemon", "Macondo", "Mate SC", "Original Surfer", "Overlock",
      "Pattaya", "Permanent Marker", "Plaster", "Playball", "Pompiere",
  ...
  },
  {
    ...
    fonts: [
      ...
      "Pinyon Script", "Marck Script", "Lily Script One", "League Script",
      "Mr Bedfort", "Mr Dafoe", "Niconne", "Nothing You Could Do",
      "Over the Rainbow", "Reenie Beanie", "Sansita Swashed", "Sail",
      "Stalemate", "Tangerine", "Yellowtail",
    ],
  },
  {
    ...
    fonts: [
      ...
      "Faster One", "Finger Paint", "Fontdiner Swanky", "Fascinate",
      ...
      "Plaster", "Protest Guerrilla", "Protest Riot", "Protest Strike",
...
const TRANSITION_FONT_GROUPS: { label: string; fonts: string[] }[] = [
  ...
  },
  {
    ...
    fonts: [
      ...
      "Yantramanav", "Mukta", "Sansita", "Sansita Swashed",
    ],
  },
  {
    ...
    fonts: [
      ...
      "Crimson Pro", "DM Serif Text", "Dosis", "EB Garamond",
      ...
      "Kameron", "Lateef", "Libre Baskerville", "Libre Caslon Text",
      "Lora Variable", "Marcellus", "Marko One", "Martel", "Merriweather Sans",
      "Neuton", "Newsreader", "Noticia Text", "Noto Serif", "Old Standard TT",
      "Palanquin", "Petrona", "Piazzolla", "Playfair", "Playfair Display SC",
      "Plus Jakarta Sans", "Prata", "Quattrocento", "Radley", "Rosarivo",
      "Rufina", "Sahitya", "Source Serif Pro", "Spectral SC",
      "STIX Two Text", "Sumana", "Tinos", "Trirong", "Ultra",
